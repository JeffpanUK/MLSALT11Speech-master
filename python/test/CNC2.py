...
if __name__ == '__main__':
	...
	c1='adapt-lm-plp'
	c2='lm_int_grph-tandem'
	comb=c1+'+'+c2
	for f in files:
		_dict1 = read_lattice(r'/home/jp697/Major/challenge/%s/%s/decode_cn/lattices/'\
			%(c1,f))
		_dict2 = read_lattice(r'/home/jp697/Major/challenge/%s/%s/decode_cn/lattices/'\
			%(c2,f))
		# print _dict1
		# input('')
		save_dict_to_file(_dict1,r'/home/jp697/Major/challenge/%s/%s/decode_cn/rescore_lattices.mlf'\
			%(c1,f))
		save_dict_to_file(_dict2,r'/home/jp697/Major/challenge/%s/%s/decode_cn/rescore_lattices.mlf'\
			%(c2,f))
		rover(r'/home/jp697/Major/challenge/%s/%s/decode_cn/rescore_lattices.mlf'%(c1,f),\
			r'/home/jp697/Major/challenge/%s/%s/decode_cn/rescore_lattices_rover.mlf'%(c1,f))
		rover(r'/home/jp697/Major/challenge/%s/%s/decode_cn/rescore_lattices.mlf'%(c2,f),\
			r'/home/jp697/Major/challenge/%s/%s/decode_cn/rescore_lattices_rover.mlf'%(c2,f))
		os.popen('echo | base/conftools/smoothtree-mlf.pl lib/trees/plp-bg_decode_cn.tree\
 	./challenge/%s/%s/decode_cn/rescore_lattices_rover.mlf \
 	> ./challenge/%s/%s/decode_cn/rescore_lattices_rover_mappingtrees.mlf'%(c1,f,c1,f))
		os.popen('echo | base/conftools/smoothtree-mlf.pl lib/trees/plp-bg_decode_cn.tree\
 	./challenge/%s/%s/decode_cn/rescore_lattices_rover.mlf \
 	> ./challenge/%s/%s/decode_cn/rescore_lattices_rover_mappingtrees.mlf'%(c2,f,c2,f))

		_dict1 = load_dict_from_file(r'/home/jp697/Major/challenge/%s/%s/decode_cn/rescore_lattices_rover_mappingtrees.mlf'%(c1,f))
		_dict2 = load_dict_from_file(r'/home/jp697/Major/challenge/%s/%s/decode_cn/rescore_lattices_rover_mappingtrees.mlf'%(c2,f))
		mlfcom=merge_mlf(_dict1,_dict2)
		dictcom = recovermlf(_dict1,_dict2,mlfcom)	
		save_dict_to_file(dictcom,r'/home/jp697/Major/challenge/mlf_cnc/%s/%s.mlf'%(comb,f))
		rover(r'/home/jp697/Major/challenge/mlf_cnc/%s/%s.mlf'%(comb,f),\
			r'/home/jp697/Major/challenge/mlf_cnc/%s/combine/%s/decode_cn/rescore.mlf'%(comb,f))
