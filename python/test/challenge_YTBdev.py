...
def main(c1,c2,decodetype):
	comb=c1+"+"+c2+'_'+decodetype
	files=readlist(r'/home/jp697/Major/exp/temp_file/challenge_dev')
	for f in files:
		if decodetype=="decode_cn":
			_dict1 = load_dict_from_file(r'/home/jp697/Major/challenge/%s/%s/%s/rescore_mappingtrees.mlf'%(c1,f,decodetype))
			_dict2 = load_dict_from_file(r'/home/jp697/Major/challenge/%s/%s/%s/rescore_mappingtrees.mlf'%(c2,f,decodetype))
		elif decodetype=='decode':
			_dict1 = load_dict_from_file(r'/home/jp697/Major/challenge/%s/%s/%s/rescore.mlf'%(c1,f,decodetype))
			_dict2 = load_dict_from_file(r'/home/jp697/Major/challenge/%s/%s/%s/rescore.mlf'%(c2,f,decodetype))
		else:
		...
		rover(r'/home/jp697/Major/challenge/mlf_combine/%s/%s.mlf'%(comb,f),\
			r'/home/jp697/Major/challenge/mlf_combine/%s/combine/%s/%s/rescore.mlf'%(comb,f,decodetype))
...
if __name__ == '__main__' :
	...
	main(args.sys1,args.sys2,args.decode_type)
